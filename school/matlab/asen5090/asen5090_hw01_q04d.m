...
clear; close all; clc;
fprintf("ASEN 5090 HOMEWORK 01 QUESTION 04D\n")
addpath('functions/')
...
code_prn05_ca = func_gen_code_CA(5,chips,0);

% change the zeros and ones 
code_prn19_ca_cor = func_code_convert(code_prn19_ca);
code_prn05_ca_cor = func_code_convert(code_prn05_ca);

%% CORRELATE

n = -1022/2:1022/2;
R_k = func_correlate_cross(n,code_prn19_ca_cor,code_prn05_ca_cor);
...
title('PRN 19 & 05 Cross Correlation')