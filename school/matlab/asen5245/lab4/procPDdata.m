...
figure(3), set(gcf,'position',[x0,y0,width,height]), subplot(121)
if (bw ~= 'y')
...
figure(4), set(gcf,'position',[x0,y0,width,height]), subplot(121)
if (bw ~= 'y')
   colormap([0 0 0]);
else
   colormap('default');
...
figure(5), set(gcf,'position',[x0,y0,width,height]), subplot(121)
if (bw ~= 'y')
   colormap([0 0 0]);
else
   colormap('default');
...
figure(6), set(gcf,'position',[x0,y0,width,height]), subplot(121)
if (bw ~= 'y')
   colormap([0 0 0]);
else
   colormap('default');
