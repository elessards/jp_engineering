...
% Experimenting with simple beamforming calculations (Richards, 2004)
...
dl = d/lambda;
N = 32;  % # of array elements
aoa_max = asin(1/2/dl);  % maximum "real space" AOA (radians)

window_on = true;  % true or false
...
target_angle = 0;
t_aoa = pi/180*(target_angle); % target AOA (radians)

jammer_angle_1 = 18; % jammer #1 AOA in degrees
j_aoa1 = pi/180*(jammer_angle_1); % jammer #1 AOA (radians)

jammer_angle_2 = -2; % jammer #2 AOA in degrees
j_aoa2 = pi/180*(jammer_angle_2); % jammer #2 AOA (radians)
...
%%%%%%%%%%%%%%%%%%%
% (1) Pre-beamforming (raw data) SIR
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% (3) Now try unity gain ("distortionless") constraint solution from Guerci
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% (4) Now try a post-DFT beamformer
